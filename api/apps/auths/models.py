...
class User(BaseModel):
  ...
  `account` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL COMMENT '账号',
    ...
    account = models.CharField(max_length=11, default=None, help_text='账号')
    username = models.CharField(max_length=32, default='', help_text='姓名')
    nickname = models.CharField(max_length=32, default='', null=True, blank=True, help_text='姓名')
    mobile = models.CharField(max_length=32, default='', blank=True, help_text='联系电话')
    email = models.CharField(max_length=32, default='', blank=True, help_text='邮件')
    ...
    expire_time = models.DateTimeField(default=None, null=True, blank=True, help_text='账号过期时间')
