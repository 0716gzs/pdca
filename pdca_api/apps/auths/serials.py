...
from common.serials import BaseSerializer, CommonBaseSerializer
...
class TaskCategorySerializer(CommonBaseSerializer):
    class Meta:
        model = TaskCategory
        fields = '__all__'


class TaskSerializer(CommonBaseSerializer):
    class Meta:
        model = Task
        fields = '__all__'
