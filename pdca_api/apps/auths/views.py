from common.views import BaseApiView, BaseParam, PermLessApiView, RowDict, BaseModelViewSet, ListModelViewSet
...
class CategoryView(BaseModelViewSet):
    ...
    edit_serializer_class = TaskCategorySerializer
    serializer_class = TaskCategorySerializer


class TaskView(BaseModelViewSet, ListModelViewSet):
    queryset = Task.objects.all().order_by('id')
    edit_serializer_class = TaskSerializer
