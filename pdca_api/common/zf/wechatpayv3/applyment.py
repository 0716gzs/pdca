...
def applyment_submit(self, business_code, contact_info, subject_info, business_info, settlement_info, bank_account_info, addition_info=None):
    ...
    if params.get('bank_account_info').get('account_number'):
        ...
        cipher_data = True
    if params.get('subject_info').get('identity_info').get('id_card_info').get('id_card_name'):
        id_card_name = params['subject_info']['identity_info']['id_card_info']['id_card_name']
        params['subject_info']['identity_info']['id_card_info']['id_card_name'] = self._core.encrypt(id_card_name)
        cipher_data = True
    if params.get('subject_info').get('identity_info').get('id_card_info').get('id_card_number'):
        id_card_number = params['subject_info']['identity_info']['id_card_info']['id_card_number']
