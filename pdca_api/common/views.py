...
class BaseModelViewSet(ModelViewSet, _MyView):
    ...
    def get_filter_object(self, filter_fields=None):
        """
        Returns the object the view is displaying, filtered by user_id.
        """
        ...
        if filter_fields:
            filter_kwargs = filter_kwargs | filter_fields
    ...
    def retrieve(self, request, *args, **kwargs):
        instance = self.get_filter_object()
